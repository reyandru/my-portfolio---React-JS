    ...
    <>
      ...
      <section className={`${isCollapse ? 'contact-collapses' : 'contact-container'}`}>
        <div className="section-head">
          <h1 className='title' style={{borderColor: theme === 'dark'? 'white':'black'}}>Contact</h1>
        </div>
        <div className="contact-details">
      <h1  className="contact-msg">Contact me:</h1>
      <div className="col-1">
        <div className="card-col-1 card-col"  style={{borderColor: theme === 'dark'? 'white':'black', backgroundColor: theme === 'dark'? '#363131':'#817777ff'}}>
      ...
      <div className="col-2">
        <div className="card-col-2 card-col"style={{borderColor: theme === 'dark'? 'white':'black', backgroundColor: theme === 'dark'? '#363131':'#817777ff'}}>
